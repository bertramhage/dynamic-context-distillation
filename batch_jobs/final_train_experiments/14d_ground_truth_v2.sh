...
### Job Name:
#BSUB -J train_only_new_02_14d_g_v2
...
uv run python -m src.training.main \
  ...
  training_loop.checkpoint_dir=checkpoints/final_14d_g_v2 \
...
bsub < batch_jobs/final_train_experiments/evals/eval_14d_ground_truth.sh
